	...
	config: {
		...
		guide: {
			vi: {
				...
				attachment: {
					[`${__dirname}/assets/guide/setwelcome/setwelcome-vi-1.png`]: "https://i.ibb.co/vd6bQrW/setwelcome-vi-1.png"
				}
			},
			en: {
				...
				attachment: {
					[`${__dirname}/assets/guide/setwelcome/setwelcome-en-1.png`]: "https://i.ibb.co/vsCz0ks/setwelcome-en-1.png"
				}
			}
		}
	},
